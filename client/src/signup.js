    ...
    <div className="form">
      <form className="centre">
        ...
        <select name="role" onChange={onTextFieldChange} value={Role}>
          ...
          <option className="heading" value={'Admin'}>
            Admin
          </option>
          <option className="heading" value={'Super Admin'}>
            Super Admin
          </option>
          <option className="heading" value={'Contractor'}>
            Contractor
          </option>
          <option className="heading" value={'Employee'}>
            Employee
          </option>
          <option className="heading" value={'Manager'}>
            Manager
          </option>
        </select>
